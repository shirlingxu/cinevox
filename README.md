...
|  |  Sentiment -> Script -> Audio -> Post      |  |
|  +--------------------------------------------+  |
|                                                   |
|  +------------+  +----------+  +--------------+  |
|  | Data       |  | Gemini   |  | Audio / Post |  |
|  | Clients    |  | AI       |  | Generation   |  |
|  | (TMDB,     |  | (Summary,|  | (TTS, Nano   |  |
|  |  OMDb,     |  |  Sent.,  |  |  Banana Pro) |  |
|  |  Reddit)   |  |  Script) |  |              |  |
|  +------------+  +----------+  +--------------+  |
|                                                   |
|  +------------+  +-----------------------------+  |
...
+--------------------------------------------------+
|              File System (data/)                  |
|  episodes/*.mp3  |  memory.json  |  digest/       |
+--------------------------------------------------+
```
...
cinevox/
  backend/
    ...
    pipeline.py                Pipeline orchestrator (8-stage sequential flow)
...
| AI Models | Gemini 2.5 Flash (text), Gemini TTS (audio), Nano Banana Pro (images) |
